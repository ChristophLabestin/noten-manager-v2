...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="privacy p-6 max-w-4xl mx-auto text-left leading-relaxed">
      ...
      <section className="mb-6">
        ...
        <h3 className="text-xl font-semibold mt-4 mb-2">Personenbezogene Daten</h3>
        <ul className="list-disc list-inside">
          ...
          <li>
            <strong>Zweck:</strong> Nutzerverwaltung, Kommunikation und Nutzung
            unserer Dienste.
          </li>
          <li>
      ...
      <section className="mb-6">
        ...
        <p>
          Eine Weitergabe deiner Daten an Dritte erfolgt nur, wenn dies für die
      ...
      <section className="mb-6">
        ...
        <p className="mt-2">
          Zur Wahrnehmung deiner Rechte genügt eine formlose Mitteilung an uns.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          um sie stets aktuell zu halten.
        </p>
      </section>
      <BackToHome />
    </div>
